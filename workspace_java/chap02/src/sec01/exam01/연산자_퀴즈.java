...
public class 연산자_퀴즈 {
	...
	2. 숫자를 바꿔도 자 ㄹ나오는지 두어번 해보기 - 테스트
		...
		/* 방법1
		//오천원
		int m5000 = money / 5000; //int 끼리 나누기니까 결과가 int(정수)
									// 예상값: 1 
		System.out.println("5천원 :"+ m5000); //결과: 1
		
		//천원
	/* int m1000 = money / 1000; //예상값2
	 * 2가 나와야하는데 7이 나옴 
	 * why? 대상금액이 7234원이라서 (내가 원하는건 7234에서 오천원이 빠진 금액)
	 * 그러면? 아까 5천원 줬으니까 7234-5000을 대상금액으로 
	 */
		//int m1000 = (money - 5000) / 1000; //결과:2 but 7000원일때만 통함
...
/*		int money3 = money2 - (1000* m1000);
		...
		*/
		...
		//money = money % 1000; 이거랑 아래연산자 같은거, 무조건 =은 오른쪽
		money %= 1000;
		int m500 = money / 500;
